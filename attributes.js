(function () { /* Begin of privacy scope */
     ...
     */
    gpf.attributes.Attribute = gpf.Class.extend({
    ...
    gpf.extend(gpf.attributes, {
        ...
        AliasAttribute: gpf.attributes.Attribute.extend({
         ...
         */
        add: function (objectClass, name, attributes) {
            var
                attributeList,
                idx,
                attribute;
