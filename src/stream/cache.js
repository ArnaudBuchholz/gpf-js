...
/*exported _gpfStreamCache*/ // gpf.stream.CacheBase
/*exported _gpfStreamCacheRead*/ // Stream read method on gpf.stream.CacheBase instance
/*exported _gpfStreamCacheWrite*/ // Stream write method on gpf.stream.CacheBase instance
/*#endif*/

/**
 * Handles a stream cached into a buffer
 *
 * @class gpf.stream.CacheBase
 * @abstract
 * @implements gpf.interfaces.IReadableStream
 */
var _gpfStreamCache = _gpfDefine("gpf.stream.CacheBase", _gpfStreamBufferBase, {
    "#": {
