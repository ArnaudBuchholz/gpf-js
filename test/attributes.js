...
describe("attributes", function () {
    ...
    describe("gpf.attributes.Attribute", function () {
        ...
        it("is available through gpf.attributes.Map", function () {
            ...
            assert(1 === attributes.member("_a").getItemsCount());
            assert(0 === attributes.member("_b").getItemsCount());
            assert(1 === attributes.member("_c").getItemsCount());
        });
        ...
        it("inherits from base class", function () {
            ...
            assert(1 === attributes.member("_a").getItemsCount());
            assert(1 === attributes.member("_b").getItemsCount());
            assert(2 === attributes.member("_c").getItemsCount());
        });
    ...
    describe("gpf.attributes.Map", function () {
        ...
        it("filters on attribute type", function () {
            ...
            assert(1 === attributesTest2Value.member("_c").getItemsCount());
        });
